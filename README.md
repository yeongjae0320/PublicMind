...
![퍼블릭마인드 메인 커버 이미지](./screenshots/1_main.png)
...
![메인 대시보드 화면](./screenshots/1_main.png)
...
![마이페이지 화면](./screenshots/2_mypage.png)
...
### 2.3 글로벌 재난/안전 대시보드
![글로벌 재난/안전 화면](./screenshots/3_safety.png)
...
### 2.4 아파트 실거래가 분석
![아파트 실거래가 화면](./screenshots/4_realestate.png)
